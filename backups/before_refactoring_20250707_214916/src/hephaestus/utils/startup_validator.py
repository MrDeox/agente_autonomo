...
class StartupValidator:
    ...
    def _validate_agent_constructors(self, config: Dict[str, Any]) -> ValidationResult:
        ...
        try:
            from hephaestus.agents.maestro_agent import MaestroAgent
            from hephaestus.agents.architect_agent import ArchitectAgent
            from hephaestus.agents.code_review_agent import CodeReviewAgent
