"""
Teste automático para agent.validation_steps.test_syntax_validator
...
try:
    import agent.validation_steps.test_syntax_validator as module
except ImportError:
    module = None

class TestAgent_Validation_Steps_Test_Syntax_Validator:
    """Testes para agent.validation_steps.test_syntax_validator"""
