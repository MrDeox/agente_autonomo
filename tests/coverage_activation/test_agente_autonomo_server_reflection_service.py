"""
Teste automático para agente_autonomo.server.reflection_service
...
try:
    import agente_autonomo.server.reflection_service as module
except ImportError:
    module = None

class TestAgente_Autonomo_Server_Reflection_Service:
    """Testes para agente_autonomo.server.reflection_service"""
