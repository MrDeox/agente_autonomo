"""
Teste automático para agent.objective_generator
...
try:
    import agent.objective_generator as module
except ImportError:
    module = None

class TestAgent_Objective_Generator:
    """Testes para agent.objective_generator"""
