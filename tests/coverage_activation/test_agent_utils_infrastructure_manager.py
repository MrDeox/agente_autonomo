"""
Teste automático para agent.utils.infrastructure_manager
...
try:
    import agent.utils.infrastructure_manager as module
except ImportError:
    module = None

class TestAgent_Utils_Infrastructure_Manager:
    """Testes para agent.utils.infrastructure_manager"""
