"""
Teste automático para agente_autonomo.server.api_core
...
try:
    import agente_autonomo.server.api_core as module
except ImportError:
    module = None

class TestAgente_Autonomo_Server_Api_Core:
    """Testes para agente_autonomo.server.api_core"""
