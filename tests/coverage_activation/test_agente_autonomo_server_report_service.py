"""
Teste automático para agente_autonomo.server.report_service
...
try:
    import agente_autonomo.server.report_service as module
except ImportError:
    module = None

class TestAgente_Autonomo_Server_Report_Service:
    """Testes para agente_autonomo.server.report_service"""
